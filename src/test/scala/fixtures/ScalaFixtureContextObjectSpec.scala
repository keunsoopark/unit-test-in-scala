...
class ScalaFixtureContextObjectSpec extends UnitSpec {
  ...
  behavior of "ADollars"
  it should "return true for 5000 dollars be greater than the product minimum balance requirement" in new ADollars with AProduct with ACustomer {
